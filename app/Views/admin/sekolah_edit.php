                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('admin/sekolah/update') ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" class="form-control <?= (isset(session('errors')['sekolah_kepalasekolah'])) ? 'is-invalid' : '' ?>" id="sekolah_kepalasekolah" name="sekolah_kepalasekolah" value="<?= old('sekolah_kepalasekolah', $sekolah->sekolah_kepalasekolah) ?>">
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" class="form-control <?= (isset(session('errors')['sekolah_kepalayayasan'])) ? 'is-invalid' : '' ?>" id="sekolah_kepalayayasan" name="sekolah_kepalayayasan" value="<?= old('sekolah_kepalayayasan', $sekolah->sekolah_kepalayayasan) ?>">
                                <div class="invalid-feedback">
